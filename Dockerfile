...
RUN echo "display_errors = On" > /etc/php/8.1/fpm/conf.d/99-extra.ini
RUN echo "display_errors = On" > /etc/php/8.1/cli/conf.d/99-extra.ini

# Configure PHP-FPM
RUN echo "catch_workers_output = On" >> /etc/php/8.1/fpm/pool.d/www.conf && \
    echo "chdir = /var/www/html/public/" >> /etc/php/8.1/fpm/pool.d/www.conf && \
    echo "php_admin_value[upload_max_filesize] = 100M" >> /etc/php/8.1/fpm/pool.d/www.conf && \
    echo "php_admin_value[post_max_size] = 100M" >> /etc/php/8.1/fpm/pool.d/www.conf
